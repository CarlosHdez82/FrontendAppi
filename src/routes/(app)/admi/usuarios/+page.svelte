...
{#if cargando}
    <LoadingSpinner />
{:else}
    <!-- Cambio: Implementación del snippet 'rowTemplate' y prop 'data' para habilitar búsqueda -->
            ...
            <tr>
                <td class="ps-4">
                    <div class="d-flex flex-column">
                        ...
                        <span class="text-muted small">ID: {u.user_id}</span>
                    </div>
                </td>
                <td>{u.email}</td>
                <td><RoleBadge roleId={u.role_id} /></td>
                ...
                <td class="text-center">
                    <TableAction 
                        ...
                        onEdit={() => prepararEdicion(u)} 
                        onDelete={() => { idSeleccionado = u.user_id; nombreBorrar = `${u.first_name} ${u.last_name}`; }} 
                    />
                </td>
            </tr>
        {/snippet}
    ...
    <div class="row g-3 text-start">
        ...
        {#if !editando}
            <div class="col-12">
                ...
                <input id="u_pass" type="password" class="form-control" bind:value={formulario.password} required>
                <div class="form-text mt-1 small">Mínimo 8 caracteres para mayor seguridad.</div>
            </div>
        {/if}
